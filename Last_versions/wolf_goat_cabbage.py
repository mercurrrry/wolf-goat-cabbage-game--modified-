...
def dfs_with_priorit(current_situation, stack = []):
    """
    ...
    for action in next_actions:
        ...
        # Если новая ситуация валидна
        if next_situation and next_situation.is_valid():
            result = dfs_with_priorit(next_situation, stack + [next_situation])    
            if result:
                return result
...
if __name__ == "__main__":
    ...
    basic_situation = Situation(
        left=Object.Wolf | Object.Goat | Object.Gabbage,
        right=Object(0),
        boat=Object(0),
        Beach=Beach.LEFT,
    )
    ...
    # situation.display()
    # situation = make_move(situation, 6)
    # situation.display()
        
    solution = dfs_with_priorit(basic_situation)
